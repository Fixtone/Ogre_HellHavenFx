...
#include "CTransitionAnimatorManager.h"
...
{
	public:
			CPlayState(CGraphicsManager* aCGraphicsManager, CInputManager* aCInputManager, CResourceManager* aCResourceManager);
			~CPlayState();
	...
	private:
			...
			CTransitionAnimatorManager*	mTransitionAnimatorManager;
			CHHParticlesManager*		mHHParticlesManager;
			CActorManager*				mActorManager;
