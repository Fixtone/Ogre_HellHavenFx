...
void CStatesManager::initialize(CGraphicsManager* aCGraphicsManager, CInputManager* aCInputManager, CResourceManager* aCResourceManager)
{
        //
		...
		this->mCResourceManager = aCResourceManager;
        ...
        //
		this->mStates[GameStateId::Play]        = new CPlayState(mCGraphicsManager, mCInputManager, mCResourceManager);        
		this->mStates[GameStateId::Exit]        = new CExitState(mCGraphicsManager, mCInputManager, mCResourceManager);              
